...
func (s *State) Eval(curNode CalcNode) (int64, error) { //nolint:funlen,gocyclo // evaluation will be hairy
	...
	if curNode.value == "-" && (curNode.left == nil || curNode.left.value == "") && curNode.right != nil {
	...
	if curNode.left != nil && len(curNode.value) == 1 && slices.Contains(Length1operatorsInfix, Operator((curNode.value)[0])) {
